...
public class midtrans_demo extends AppCompatActivity implements TransactionFinishedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_midtrans_demo);
        bindViews();
...
//        creditCard.setChannel(CreditCard.MIGS); //set channel migs
    ...
    private CustomerDetails initCustomerDetails() {
        ...
        mCustomerDetails.setFirstName("Ferdinandus Yonata");
        mCustomerDetails.setEmail("jetfredy@yahoo.com");
    ...
    private void initActionButtons() {
        buttonUiKit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this);
            }
        });
        ...
        buttonDirectCreditCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().UiCardRegistration(midtrans_demo.this, new CardRegistrationCallback() {
                    @Override
                    public void onSuccess(CardRegistrationResponse cardRegistrationResponse) {
                        Toast.makeText(midtrans_demo.this, "register card token success", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(CardRegistrationResponse cardRegistrationResponse, String s) {
                        Toast.makeText(midtrans_demo.this, "register card token Failed", Toast.LENGTH_SHORT).show();
        ...
        buttonDirectBcaVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this, PaymentMethod.BANK_TRANSFER_BCA);
            }
        });
        ...
        buttonDirectBniVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this, PaymentMethod.BANK_TRANSFER_BNI);
            }
        });
        ...
        buttonDirectMandiriVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this, PaymentMethod.BANK_TRANSFER_MANDIRI);
            }
        });
        ...
        buttonDirectPermataVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this, PaymentMethod.BANK_TRANSFER_PERMATA);
            }
        });
        ...
        buttonDirectAtmBersamaVa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MidtransSDK.getInstance().setTransactionRequest(initTransactionRequest());
                MidtransSDK.getInstance().startPaymentUiFlow(midtrans_demo.this, PaymentMethod.BCA_KLIKPAY);
            }
        });
